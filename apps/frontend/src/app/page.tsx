    ...
    <div className="">
      ...
      <section className="smooth-card mb-4">
        <div className="container-center ">
          <p className="text-center text-h3 mb-6 tracking-tighter text-text-main">
      ...
      {/* 3. POPULAR SERVICES */}
      <section id="popular-services" className="bg-brand-bg p-4 md:p-12 mb-4">
      ...
      <section className="bg-brand-dark p-4 md:p-12 relative  mb-4">
      ...
      <section className="smooth-card mb-4 p-4 md:p-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="smooth-card rounded-[3rem] p-12 relative z-10 border border-accent/10">
      ...
      {/* 6. CATEGORY GRID */}
      <section className="bg-brand-bg shadow p-4 md:p-12 mb-4">
        <div className="container-center">
      ...
      {/* 7. FAQ SECTION */}
      <section id="faqs" className="smooth-card mb-4 p-4 md:p-12">
        <FAQSection />
      </section>
    </div>
  );
...
function CategoryCard({
  ...
  return (
    <div className="smooth-card p-6 border border-card-border rounded-lg hover:border-accent transition-all shadow-sm">
