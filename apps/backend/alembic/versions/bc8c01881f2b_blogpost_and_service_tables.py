...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "seo_description", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("content", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "related_services", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.alter_column(
        "services", "description", existing_type=sa.VARCHAR(), nullable=False
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "services", "description", existing_type=sa.VARCHAR(), nullable=True
    )
